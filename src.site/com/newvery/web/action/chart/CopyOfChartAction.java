 ...
 *
 */
public class CopyOfChartAction extends BaseWebAction {
	...
	public String init() throws Exception {
		...
		if(getRequest().getParameter("optionsRadio") != null) {//必须带查询条件
		...
		switch (optionsRadio) {
			case 1:
				if(cid != null && cid.length > 0 ) {
					...
					List<Long> childFavoritIds = new ArrayList<Long>();
					for (Long c : cid) {
						childFavoritIds.add(c);
					}
					query.put("childFavoritIds", childFavoritIds);
				}
				break;
			case 2:												//时间
