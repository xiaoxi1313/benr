...
public class SystemConfig {
	...
	public static final String PRODUCT_IMAGE_FILE_EXTENSION = "jpeg";
	
	public static final String NO_IMAGE = "/resources/admin/images/noimage.jpg";
	...
	public static final String UPLOAD_LOGO_DIR = "/upload/logo/";// LOGO文件上传目录
	public static final String UPLOAD_TRADER_AUTH_IMAGE_DIR = "/upload/image/traderauth/";
	public static final String UPLOAD_ORDER_VOUCHER_IMAGE_DIR = "/upload/image/order/voucher/";
	public static final String UPLOAD_PRODUCT_IMAGE_DIR = "/upload/image/product/";
