...
function addCategoryRow() {
	$('#selectCategoryTr').find("#parentCategoryList_chosen").remove();
...
function assignCategory(userId) {
	...
	$('#userId').val(userId);
	$.post("user_getAssignCategory.action?user.id=" + userId,
		function (data, textStatus) {
			if (data.errorCode == 0) {
				$.each(data.userFavoriteList, function(i, item){
					var favoriteTr ="<tr><th>";
     ...
     <div class="modal-dialog">
       ...
       <div class="modal-header">
         ...
         <div class="modal-body wrapper-lg">
           <div class="row">
             <div class="col-sm-12">
             					<form id="updateForm" method="post" action="user_updateAssignCategory.action">
		                                                ...
		                                                <tr id="selectTr" class="chooselist" style="display:none;">
			                                                <th>
				                                                <div class="col-sm-5 no-padder m-r" >
				                                                 ...
				                                                 <select a="aaa" class="fchosen-select" name="cid" id="parentFavoriteList" >
		...
		<div class="modal-content">
			...
			<div class="modal-body wrapper-lg">
				<div class="row">
									...
									<table style="width:100%;">
										<thead>
											<tr id="selectCategoryTr" class="chooselist" style="display:none;">
												<th>
													<div class="col-sm-5 no-padder m-r">
														<select a="aaa" id="parentCategoryList">
															<option value="-1">请选择</option>
					...
					<div class="checkbox m-t-lg" style="height: 0px;">
						<br /> <br /> <br />
						<button onclick="updatePermission()" class="btn btn-md btn-success pull-right text-uc m-t-n-xs">
							<strong>保存修改</strong>
						</button>
					</div>
				</div>
