	...
	<div class="item col-sm-12 col-md-6 post hulianwang">
		<section class="panel b-a">
			<div class="clearfix text-center m-b-sm title-pic">
				<div class="picframe">
					<a class="row-title" href="article_show.action?article.id=<s:property value='id' />" target="_blank">
					<img src="<s:property value='titleImage' />" class="thumb-o">
					</a>
					<div class="hover-content">
						<div class="overlay"></div>
						<div class="link-contianer">
							<a class="row-title" href="article_show.action?article.id=<s:property value='id' />" target="_blank">查看详情</a>
						</div>
					</div>
				</div>
				<a class="row-title" href="article_show.action?article.id=<s:property value='id' />" target="_blank">
				...
				<div class="text-danger postedtime">
					<s:date name="#article.createTime" format="yyyy年MM月dd日" />
				</div>
				...
				<div class="text-muted p-b-md p-t-xs m-b-sm b-b">
					收藏至：<span><s:property value="childFavorite.name" />
					</span>
				</div>
				<div class="text-left abs-text">
			...
			<div class="clearfix panel-footer">
				<s:iterator value="chartDistributionList" id="chartDistribution" status="s">
					<a href="javascript:void(0)" onclick="showright(<s:property value='#chartDistribution.tagId' />,'<s:property value="#chartDistribution.tagName" />');" class="tag bg-success r-coner-lg font-sm">
