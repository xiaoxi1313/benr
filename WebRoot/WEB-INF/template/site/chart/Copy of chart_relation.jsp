...
<script src="<%=UrlHelper.getHomeUrl()%>resources/common/js/charts/flot/jquery.flot.orderBars.js"></script>
...
function addfloderrown(obj) {
	...
	$('#selectfolder').next().find(".chosen-container").remove();
	$('#selectfolder').next().find("select[name='yid']").chosen();
	$('#selectfolder').next().find("select[name='yid']").prop('disabled', false).trigger("chosen:updated");
	$('#selectfolder').next().find("select[name='fid']").chosen();
	$('#selectfolder').next().find("select[name='fid']").prop('disabled', false).trigger("chosen:updated");
	//$('#selectfolder').next().find("select[c='ccc']").multiSelect({keepOrder: true });
}
          ...
          <section class="vbox">
            <section class="scrollable padder">
              ...
              <section class="panel panel-default">
                  <header class="panel-heading">关联分析工具</header>
                  ...
                  <section class="panel panel-default" id="chartSection"
                      ...
                      <header class="panel-heading">饼状图分析结果</header>
                        ...
                        <a href="#modal-saveresult" data-toggle="modal" class="btn btn-success btn-sm">保存图表</a>
                        </div>
                  ...
                  <section class="panel panel-default">
                                  ...
                                  <aside class="aside-sm bg-success lt b-r" id="taglist">
                                    ...
                                    <div id="filters" class="col-sm-6 button-group no-padder">
                                        <button class="btn btn-sm btn-default btn-rounded m-b-xs" data-filter="*">全部资讯</button>
